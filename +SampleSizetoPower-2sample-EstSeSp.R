...
SampleSizetoPower2sampleEstSeSp(true_p1 = 0.01,
                                true_p2 = 0.1,
                                Se1_n = 20,
                                Se1_exp = 1,
                                Sp1_n = 20,
...
true_p1=c(.01,.02,.03,.05,.10,.20,.30)
true_p2=c(.10,.12,.13,.15,.20,.35,.50)
for (i in 1:length(true_p1)) 
  for (Se1_exp in c(1,.99,.98,.95, 0.9)) for (Sp1_exp in c(1,.99,.98,.95, 0.9))
    for (Se2_exp in c(1,.99,.98,.95, 0.9)) for (Sp2_exp in c(1,.99,.98,.95, 0.9))
      for (Se1_n in c(20, 50, 100, 500, 1000, 5000)) for (Sp1_n in c(20, 50, 100, 500, 1000, 5000))
        for (Se2_n in c(20, 50, 100, 500, 1000, 5000)) for (Sp2_n in c(20, 50, 100, 500, 1000, 5000))
  cat("true_p1:",true_p1[i],"true_p1:",true_p2[i],"Se1_exp:",Se1_exp,"Se1_n:",Se1_n,"Sp1_exp:",Sp1_exp,"Sp1_n:",Sp1_n,
      "Se2_exp:",Se2_exp,"Se2_n:",Se2_n,"Sp2_exp:",Sp2_exp,"Sp2_n:",Sp2_n,
      "Sample Size: ", SampleSizetoPower2sampleEstSeSp(true_p1 = true_p1[i], true_p2 = true_p2[i], Se1_n = Se1_n, Se1_exp = Se1_exp,
                                                       Sp1_n = Sp1_n, Sp1_exp = Sp1_exp, Se2_n = Se2_n, Se2_exp = Se2_exp, Sp2_n = Sp2_n,
                                                       Sp2_exp = Sp2_exp),"\n", file = "interimresults_2Sample_Est-SS.txt", append = TRUE)
